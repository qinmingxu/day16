...
public class GetCartsbean {
    ...
    public static class DataBean {
        ...
        public DataBean setChecked(boolean checked) {
        ...
        public static class ListBean {
            ...
            public ListBean setCount(int count) {
                this.count = count;
                return this;
            }
            ...
            public ListBean setChecked(boolean checked) {
                this.checked = checked;
                return this;
            }
